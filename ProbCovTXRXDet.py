...
#for transmitter
KReduced_hTX=np.sqrt(1-hMatrixReduced.transpose())*KPalmReducedTX*np.sqrt(1-hMatrixReduced);
##for reciever and transmitter
KReduced_hRX=np.sqrt(1-hMatrixReduced.transpose())*KPalmSemiReducedTXRX*np.sqrt(1-hMatrixReduced);
